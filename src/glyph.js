...
export class Glyph {
  ...
  getMetrics() {
    ...
    metrics.rightSideBearing = this.advanceWidth - metrics.leftSideBearing -
  ...
  drawMetrics(ctx, x, y, fontSize) {
    ...
    // Draw the origin
    ctx.strokeStyle = Glyph.stroke.origin;
    ...
    // Draw the glyph box
    ctx.strokeStyle = Glyph.stroke.bbox;
    ...
    ctx.strokeStyle = Glyph.stroke.advanceWidth;
    draw.line(
      ctx,
