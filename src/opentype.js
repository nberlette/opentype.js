...
import { addGlyphNames, CmapEncoding, GlyphNames } from "./encoding.js";
...
function uncompressTable(data, tableEntry) {
  if (tableEntry.compression === "WOFF") {
    ...
    if (outBuffer.byteLength !== tableEntry.length) {
      throw new Error(
        "Decompression error: " + tableEntry.tag +
...
function parseBuffer(buffer, opt = {}) {
  ...
  if (
    signature === String.fromCharCode(0, 1, 0, 0) || signature === "true" ||
    signature === "typ1"
  ) {
