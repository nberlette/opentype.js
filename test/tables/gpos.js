...
describe("tables/gpos.js", function () {
  ...
  it("can parse a GPOS header", function () {
    ...
    assert.deepEqual(gpos.parse(data), {
      version: 1,
      scripts: [],
      features: [],
      lookups: [],
  ...
  it("can parse lookup1 SinglePosFormat1 with ValueFormat Table and ValueRecord", function () {
    ...
    const data =
      "0001 000E 0099   0050 00D2 0018 0020   0002 0001 00C8 00D1 0000   000B 000F 0001 5540   000B 000F 0001 5540";
    assert.deepEqual(parseLookup(1, data), {
      posFormat: 1,
      coverage: {
        format: 2,
  ...
  it("can parse lookup1 SinglePosFormat2", function () {
    ...
    const data =
      "0002 0014 0005 0003   0032 0032   0019 0019  000A 000A   0001 0003 004F 0125 0129";
    assert.deepEqual(parseLookup(1, data), {
      posFormat: 2,
      coverage: {
        format: 1,
