...
describe("tables/gsub.js", function () {
  ...
  it("can parse lookup5 substFormat 1", function () {
    ...
    assert.deepEqual(parseLookup(5, data), {
      ...
      ruleSets: [
        ...
        [{
          input: [0x28],
          lookupRecords: [{ sequenceIndex: 1, lookupListIndex: 1 }],
        }],
      ],
    });
  });
  ...
  it("can parse lookup5 substFormat 2", function () {
    ...
    assert.deepEqual(parseLookup(5, data), {
      ...
      classSets: [
        ...
        [{
          classes: [1],
          lookupRecords: [{ sequenceIndex: 1, lookupListIndex: 2 }],
        }],
      ],
    });
  });
  ...
  it("can parse lookup6 substFormat1", function () {
    ...
    const data = "0001  0008  0001" + // substFormat, coverageOffset, chainSubRuleSetCount
  ...
  it("can parse lookup6 substFormat3", function () {
    ...
    const data = "00 03    00 02" + // substFormat and backtrackGlyphCount
