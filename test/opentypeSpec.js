...
import { Font, Glyph, load, parse, Path } from "../src/opentype.js";
...
describe("opentype.js", function () {
  ...
  it("can load a OpenType/CFF font", function () {
    ...
    assert.deepEqual(font.names.macintosh.fontFamily, {
      en: "Fira Sans OT Medium",
    });
    assert.deepEqual(font.names.windows.fontFamily, {
      en: "Fira Sans OT Medium",
    });
  ...
  it(
    "[deprecated] .load() handles a parseBuffer error as a rejected promise",
    function (done) {
