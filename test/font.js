...
import { Font, Glyph, parse, Path } from "../src/opentype.js";
...
describe("font.js", function () {
  ...
  describe("Font constructor", function () {
    ...
    it("tables definition shall be serialized", function () {
      const os2 = font.toTables().tables.find((table) =>
        table.tableName === "OS/2"
      );
  ...
  describe("stringToGlyphIndexes", function () {
    it("must support standard ligatures", function () {
      assert.deepEqual(font.stringToGlyphIndexes("fi"), [
        fGlyph.index,
        iGlyph.index,
      ]);
  ...
  describe("stringToGlyphs", function () {
    it("must support standard ligatures", function () {
      ...
      assert.deepEqual(font.stringToGlyphs("fffiffif"), [
        ffGlyph,
        fiGlyph,
        ffiGlyph,
        fGlyph,
